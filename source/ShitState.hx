...
//luke adds stuff here:
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?customImage:Null<BitmapData>, ?customXml:Null<String>, ?customEnds:Null<BitmapData>, NoteType:String = 'normal')
	{
		super();
		...
		switch (PlayState.SONG.uiType)
		{
			...
			case 'normal':
				...
				//luke adds more stuff here heheheh
