...
class Note extends FlxSprite
{
	...
	public static var _strumTime:Float;
	public static var _noteData:Int;

//	public function new(_strumTime:Float, _noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0, ?inCharter:Bool = false) 
	{
		...
		switch (noteTypeCheck)
		{
			...
			default:
				...
				frames = Paths.getSparrowAtlas('Electricnotes');
					
				animation.addByPrefix('greenScroll', 'electric up');
				animation.addByPrefix('redScroll', 'electric right');
				animation.addByPrefix('blueScroll', 'electric down');
				animation.addByPrefix('purpleScroll', 'electric left');
