...
class Controls extends FlxActionSet
{
	...
	public function loadKeyBinds()
	{
		...
		inline bindKeys(Control.UP, [(FlxG.save.data.upBind == null ? W : FlxKey.fromString(FlxG.save.data.upBind)), FlxKey.UP]);
		inline bindKeys(Control.DOWN, [(FlxG.save.data.downBind == null ? S : FlxKey.fromString(FlxG.save.data.downBind)), FlxKey.DOWN]);
		inline bindKeys(Control.LEFT, [(FlxG.save.data.leftBind == null ? A : FlxKey.fromString(FlxG.save.data.leftBind)), FlxKey.LEFT]);
		inline bindKeys(Control.RIGHT, [(FlxG.save.data.rightBind == null ? D : FlxKey.fromString(FlxG.save.data.rightBind)), FlxKey.RIGHT]);
		...
		inline bindKeys(Control.N0, [(FlxG.save.data.N0Bind == null ? A : FlxKey.fromString(FlxG.save.data.N0Bind))]);
		inline bindKeys(Control.N1, [(FlxG.save.data.N1Bind == null ? S : FlxKey.fromString(FlxG.save.data.N1Bind))]);
		inline bindKeys(Control.N2, [(FlxG.save.data.N2Bind == null ? D : FlxKey.fromString(FlxG.save.data.N2Bind))]);
		inline bindKeys(Control.N3, [(FlxG.save.data.N3Bind == null ? F : FlxKey.fromString(FlxG.save.data.N3Bind))]);
		inline bindKeys(Control.N4, [(FlxG.save.data.N4Bind == null ? SPACE : FlxKey.fromString(FlxG.save.data.N4Bind))]);
		inline bindKeys(Control.N5, [(FlxG.save.data.N5Bind == null ? H : FlxKey.fromString(FlxG.save.data.N5Bind))]);
		inline bindKeys(Control.N6, [(FlxG.save.data.N6Bind == null ? J : FlxKey.fromString(FlxG.save.data.N6Bind))]);
		inline bindKeys(Control.N7, [(FlxG.save.data.N7Bind == null ? K : FlxKey.fromString(FlxG.save.data.N7Bind))]);
		inline bindKeys(Control.N8, [(FlxG.save.data.N8Bind == null ? L : FlxKey.fromString(FlxG.save.data.N8Bind))]);

		inline bindKeys(Control.L1, [(FlxG.save.data.L1Bind == null ? S : FlxKey.fromString(FlxG.save.data.L1Bind))]);
		inline bindKeys(Control.U1, [(FlxG.save.data.U1Bind == null ? D : FlxKey.fromString(FlxG.save.data.U1Bind))]);
		inline bindKeys(Control.R1, [(FlxG.save.data.R1Bind == null ? F : FlxKey.fromString(FlxG.save.data.R1Bind))]);
		inline bindKeys(Control.L2, [(FlxG.save.data.L2Bind == null ? J : FlxKey.fromString(FlxG.save.data.L2Bind))]);
		inline bindKeys(Control.D1, [(FlxG.save.data.D1Bind == null ? K : FlxKey.fromString(FlxG.save.data.D1Bind))]);
		inline bindKeys(Control.R2, [(FlxG.save.data.R2Bind == null ? L : FlxKey.fromString(FlxG.save.data.R2Bind))]);
	}
