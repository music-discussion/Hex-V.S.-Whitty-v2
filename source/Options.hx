...
class NoSawsOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.noSaw = !FlxG.save.data.noSaw;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.noSaw ? "No Sawblades" : "Yes Sawblades";
	}
}

class CustomSongsOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.customSongs = !FlxG.save.data.customSongs;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.customSongs ? "Custom Songs" : "Preinstalled Songs";
	}
}