...
//	var titleBG:FlxSprite;
	...
	/*	var titleBG:FlxSprite = new FlxSprite(0,0);
		titleBG.setGraphicSize(Std.int(titleBG.width));
	//	titleBG.frames = Paths.getSparrowAtlas('titleBG');
		titleBG.frames = Paths.getSparrowAtlas('titleBG');
		titleBG.animation.addByPrefix('menuplay', 'move bg', 8);
		titleBG.animation.play('menuplay');
