...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Gameplay", [
			new GhostTapOption("Virgin Input when you tap a direction and it doesn't give you a miss. Chad disables that grace."),
		...
		//	#if debug
			new BotPlay("Showcase your charts and mods with autoplay."), //decided to allow botplay to the public
		//	#end
		]),
		new OptionCategory("Experimental", [
			...
			new CustomSongsOption("Switche between using custom and premade title songs."),
			#if debug
			new NoSawsOption("Disables and enables sawblades in songs."),
			#end
		]),
