...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'allico':
				dialogue = CoolUtil.coolTextFile(Paths.txt('allico/allicoDialogue'));
			case 'numb':
				dialogue = CoolUtil.coolTextFile(Paths.txt('numb/numbDialogue'));
			case 'return':
				dialogue = CoolUtil.coolTextFile(Paths.txt('return/returnDialogue'));
		}
			...
			case 'environment':
				{
						defaultCamZoom = 0.9;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('environment/environment'));
						bg.antialiasing = true;
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curBeat == 31 && curSong == 'Allico')
		{
			dad.playAnim('hey', true);
		}
		if (curBeat == 31 && curSong == 'Return')
		{
			dad.playAnim('hey', true);
		}
		if (curBeat == 135 && curSong == 'Return')
		{
			dad.playAnim('hey', true);
		}
		if (curBeat == 363 && curSong == 'Return')
		{
			dad.playAnim('hey', true);
		}
		if (curBeat == 203 && curSong == 'Return')
		{
			dad.playAnim('hey', true);
		}
		if (curBeat == 283 && curSong == 'Return')
		{
			boyfriend.playAnim('hey', true);
		}
		if (curBeat == 434 && curSong == 'Return')
		{
			dad.playAnim('malfunction', true);
		}
		if (curBeat == 435 && curSong == 'Return')
		{
			dad.playAnim('idle', true);
		}
		if (curBeat == 437 && curSong == 'Return')
		{
			dad.playAnim('malfunction', true);
		}
		if (curBeat == 440 && curSong == 'Return')
		{
			dad.playAnim('lookatem', true);
		}
